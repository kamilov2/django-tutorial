...
function user_data() {
    $.ajax({
        ...
        success: function(data) {
            ...
            vod_hash = data.vod_hash2;
            vod_time = data.vod_time2;
            ...
            if (data.allow_watch == 0) {
                $('#watch').html('<div class="alert">'+
                    ...
                    '<p>1. Подключите любой платный VPN или установите бесплатное <a href="https://chrome.google.com/webstore/search/VPN?hl=ru&_category=extensions" target="_blank">расширение</a> для браузера (но у бесплатных расширений могут отсутствовать сервера расположенные в тех странах, с которых разрешен просмотр).</p>'+
                    '<p>2. Скачайте приложение и в настройках VPN укажите одну из следующих стран: Россия, Украина, Белоруссия, Казахстан, Армения, Азербайджан, Грузия, Узбекистан, Киргизия, Туркмения, Молдова, Турция.</p>'+
                    '<p>3. Зайдите на сайт и наслаждайтесь просмотром.</p>'+
                '</div>');
            }
